# Set some sane defaults for the sleo navigation launch environment
...
: ${SLEO_MAP_FILE:=`rospack find sleo_navigation`/maps/willow-2010-02-18-0.10.yaml}

# Exports
export SLEO_MAP_FILE
